...
<head>
	...
	<script language="JavaScript">
		function chamarRegistro(){	
			window.location.href='http://localhost/Projeto_Chamado_engSoft/registrar_chamado.php'; //redireciona
		}
...
<body>
	<div class="container">
		...
		<header>
			<div class="center">
				<div class="loggout">
					<a href="<?php echo INCLUDE_PATH_PAINELe ?>?loggout">Sair<i class="fa-solid fa-house"></i></a>
				</div><!--loggout-->
				<div class="clear"></div>
