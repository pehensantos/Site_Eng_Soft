...
<head>
	...
	<link href="<?php echo INCLUDE_PATHe ?>Interfaces/CSSf/style.css" rel="stylesheet">
	...
	<style>
        ...
        body {
            ...
            margin: 0;
            padding: 0;
            background-image: url('logo-fatec.png'); /* Substitua 'caminho_para_sua_imagem.jpg' pelo caminho da sua imagem de fundo */
