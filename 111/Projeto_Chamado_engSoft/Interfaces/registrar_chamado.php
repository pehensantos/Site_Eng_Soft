...
.container {
    max-width: 680px; /* Aumentando a largura máxima do conteúdo */
    width: calc(100% - 40px);
    padding: 20px;
...
<button class="buttoon" onclick="history.back()" style="position: absolute; top: 10px; left: 10px;">
	...
	<div class="container">
		...
		<form action="../Processos/processar_reclamacao.php" method="post">
			...
			<label for="data"><h2>Informe a data (AAAA/MM/DD):<h2></label>
				<textarea id="data" name="data" cols="20" rows="2"></textarea>

	
 

			<button class="cssbuttons-io-button" name="enviar" value="Enviar">Enviar
      <div class="icon">
